...
public class Solution {
     ...
     */
    public List<Integer> kSortedArrays(int[][] arrays) {
        ...
        int[] newArray = Helper(arrays, 0, arrays.length - 1);
    ...
    private int[] Helper(int[][] arrays, int start, int end) {
        ...
        return TwoArrays(left, right);
    }
    
    private int[] TwoArrays(int[] array1, int[] array2) {
...
// iterator for  k sorted arrays, heap: O(nlogk) time, O(k) space
public class iteratorForkSortedArrays {
    /**
     * @param arrays k sorted integer arrays
     * @return a sorted array
     */
    ...
    public iteratorForkSortedArrays(ArrayList<ArrayList<Integer>> arrays) {
